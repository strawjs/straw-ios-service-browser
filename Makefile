...
doc-release:
	appledoc --project-name 'StrawServiceBrowser' --project-company 'strawjs.org' --company-id 'org.strawjs' --output doc/v0.1.3 --create-html --no-create-docset StrawServiceBrowser
