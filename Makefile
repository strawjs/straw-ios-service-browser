...
doc-release:
	appledoc --project-name 'StrawServiceBrowser' --project-company 'strawjs.org' --company-id 'org.strawjs' --output doc/v0.1.2 --create-html --no-create-docset StrawServiceBrowser
